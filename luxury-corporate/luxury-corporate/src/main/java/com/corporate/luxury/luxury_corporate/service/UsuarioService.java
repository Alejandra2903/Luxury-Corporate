 ...
 * Usa almacenamiento en memoria (Map) mientras no haya BD.
 * Cuando conectes PostgreSQL, reemplazas esto con un Repository JPA.
 */
@Service
public class UsuarioService {
    ...
    public List<Usuario> listarTodos() {
        ...
        // Ordenar primero por Rol (Jerarquía) y luego alfabéticamente por Nombre
        lista.sort(Comparator.comparing(Usuario::getRol)
    ...
    public Usuario crear(Usuario usuario) {
        ...
        // Regla: 1 Nombre y 2 Apellidos (mínimo 3 palabras)
        ...
        // Regla: Solo correos corporativos
    ...
    public long contarOperadores() {
        long count = 0;
        List<Usuario> lista = new ArrayList<>(usuarios.values());
        // Uso de bucle FOR y IF (Requisito CRÍTICO del prompt)
    ...
    // ── LÓGICA DE NEGOCIO DEMOSTRABLE (Requisito de la Rúbrica) ──
    
    /**
     * Este método cumple explícitamente con el uso de estructuras for e if.
     * Recorre la lista de usuarios y desactiva aquellos que no han ingresado
